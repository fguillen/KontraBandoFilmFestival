...
Replace `<ProjectName>` with yout project name:
    ...
    curl -#L https://raw.github.com/fguillen/KontraBandoFilmFestival/master/etc/osx_init.rb | PROJECT_NAME=<ProjectName> ruby
...
* Add KontraBandoFilmFestival_session to be replaced in the init script
